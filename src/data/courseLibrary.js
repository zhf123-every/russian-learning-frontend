        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 21, russian: 'Рад вас ви́деть!', chinese: '很高兴见到您！' },
              { id: 22, russian: 'Мы давно́ не ви́делись.', chinese: '我们好久没见了。' },
              { id: 23, russian: 'Что но́вого?', chinese: '有什么新鲜事吗？' },
              { id: 24, russian: 'Всё в поря́дке, спаси́бо.', chinese: '一切都好，谢谢。' },
              { id: 25, russian: 'Приве́т, как ты?', chinese: '嗨，你好吗？' },
              { id: 26, russian: 'Я то́же рад тебя́ ви́деть.', chinese: '我也很高兴见到你。' },
              { id: 27, russian: 'До́брое у́тро, как спа́лось?', chinese: '早上好，睡得怎么样？' },
              { id: 28, russian: 'Прия́тно познако́миться.', chinese: '很高兴认识你。' },
              { id: 29, russian: 'Познако́мьтесь, э́то моя́ жена́.', chinese: '请认识一下，这是我妻子。' },
              { id: 30, russian: 'Каки́е у вас пла́ны на сего́дня?', chinese: '您今天有什么计划？' },
              { id: 31, russian: 'Хоро́шего ве́чера!', chinese: '晚上愉快！' },
              { id: 32, russian: 'Уви́димся за́втра!', chinese: '明天见！' },
              { id: 33, russian: 'Переда́йте приве́т ва́шей семье́.', chinese: '请代我向您的家人问好。' },
              { id: 34, russian: 'Я то́же о́чень рад.', chinese: '我也很高兴。' },
              { id: 35, russian: 'Добро́ пожа́ловать!', chinese: '欢迎！' },
              { id: 36, russian: 'С прие́здом!', chinese: '欢迎到来！' },
              { id: 37, russian: 'Как пожива́ете?', chinese: '您过得怎么样？' },
              { id: 38, russian: 'Непло́хо, а у вас?', chinese: '还不错，您呢？' },
              { id: 39, russian: 'Спаси́бо за приглаше́ние.', chinese: '谢谢邀请。' },
              { id: 40, russian: 'Мне бы́ло о́чень прия́тно.', chinese: '我很愉快。' },
              { id: 41, russian: 'До ско́рого!', chinese: '回头见！' },
              { id: 42, russian: 'Споко́йной но́чи!', chinese: '晚安！' },
              { id: 43, russian: 'О́чень хорошо́ с ва́ми познако́миться.', chinese: '认识您真好。' },
              { id: 44, russian: 'Вы о́чень любе́зны.', chinese: '您很客气。' },
              { id: 45, russian: 'Дава́йте созво́нимся по́зже.', chinese: '我们晚点通电话吧。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 21, russian: 'Меня́ зову́т И́горь.', chinese: '我叫伊戈尔。' },
              { id: 22, russian: 'А как вас зову́т?', chinese: '那您叫什么名字？' },
              { id: 23, russian: 'Отку́да вы?', chinese: '您从哪里来？' },
              { id: 24, russian: 'Мне три́дцать лет.', chinese: '我三十岁。' },
              { id: 25, russian: 'Я жена́т.', chinese: '我结婚了。' },
              { id: 26, russian: 'У меня́ есть де́ти.', chinese: '我有孩子。' },
              { id: 27, russian: 'Мой сын хо́дит в шко́лу.', chinese: '我儿子上学。' },
              { id: 28, russian: 'Я рабо́таю учи́телем.', chinese: '我是老师。' },
              { id: 29, russian: 'Моя́ рабо́та интере́сная.', chinese: '我的工作很有趣。' },
              { id: 30, russian: 'Я говорю́ по-ру́сски пло́хо.', chinese: '我俄语说得不好。' },
              { id: 31, russian: 'Я изуча́ю ру́сский два го́да.', chinese: '我学俄语两年了。' },
              { id: 32, russian: 'Э́то моя́ визи́тная ка́рточка.', chinese: '这是我的名片。' },
              { id: 33, russian: 'Я прие́хал из Кита́я.', chinese: '我来自中国。' },
              { id: 34, russian: 'Мы знако́мы давно́.', chinese: '我们认识很久了。' },
              { id: 35, russian: 'О́чень рад познако́миться с ва́ми.', chinese: '很高兴认识您。' },
              { id: 36, russian: 'Я студе́нт пе́рвого ку́рса.', chinese: '我是一年级学生。' },
              { id: 37, russian: 'Мой факульте́т — эконо́мика.', chinese: '我的系是经济学。' },
              { id: 38, russian: 'Я живу́ в общежи́тии.', chinese: '我住在宿舍。' },
              { id: 39, russian: 'Моя́ семья́ живёт в го́роде.', chinese: '我的家人住在城市。' },
              { id: 40, russian: 'Я люблю́ путеше́ствовать.', chinese: '我喜欢旅行。' },
              { id: 41, russian: 'Моё хо́бби — футбо́л.', chinese: '我的爱好是足球。' },
              { id: 42, russian: 'Я ча́сто слу́шаю му́зыку.', chinese: '我经常听音乐。' },
              { id: 43, russian: 'Свобо́дное вре́мя я провожу́ до́ма.', chinese: '空闲时间我在家度过。' },
              { id: 44, russian: 'Рад познако́миться с тобо́й.', chinese: '很高兴认识你。' },
              { id: 45, russian: 'Мы бу́дем друзья́ми.', chinese: '我们会成为朋友。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 21, russian: 'Четы́ре, пять, шесть.', chinese: '四，五，六。' },
              { id: 22, russian: 'Семь, во́семь, де́вять, де́сять.', chinese: '七，八，九，十。' },
              { id: 23, russian: 'Ско́лько сту́льев в ко́мнате?', chinese: '房间里有多少把椅子？' },
              { id: 24, russian: 'Здесь четы́ре сту́ла.', chinese: '这里有四把椅子。' },
              { id: 25, russian: 'Э́то больша́я кни́га.', chinese: '这是一本大书。' },
              { id: 26, russian: 'Ма́ленькая ко́шка спит.', chinese: '小猫在睡觉。' },
              { id: 27, russian: 'Мой телефо́н но́вый.', chinese: '我的手机是新的。' },
              { id: 28, russian: 'Ста́рый дом ря́дом.', chinese: '老房子在旁边。' },
              { id: 29, russian: 'Хоро́шая пого́да сего́дня.', chinese: '今天天气好。' },
              { id: 30, russian: 'Плоха́я иде́я.', chinese: '坏主意。' },
              { id: 31, russian: 'У меня́ есть ключ.', chinese: '我有钥匙。' },
              { id: 32, russian: 'Где мой рюкза́к?', chinese: '我的背包在哪里？' },
              { id: 33, russian: 'Э́то ру́сский слова́рь.', chinese: '这是俄语词典。' },
              { id: 34, russian: 'Да́йте мне, пожа́луйста, ру́чку.', chinese: '请给我一支钢笔。' },
              { id: 35, russian: 'Мо́жно откры́ть окно́?', chinese: '可以开窗吗？' },
              { id: 36, russian: 'За́кройте дверь, пожа́луйста.', chinese: '请关门。' },
              { id: 37, russian: 'Э́тот стул удо́бный.', chinese: '这把椅子很舒服。' },
              { id: 38, russian: 'Мне ну́жен лист бума́ги.', chinese: '我需要一张纸。' },
              { id: 39, russian: 'В су́мке лежи́т телефо́н.', chinese: '包里放着手机。' },
              { id: 40, russian: 'Ско́лько вам лет?', chinese: '您多大年纪？' },
              { id: 41, russian: 'Мне два́дцать пять лет.', chinese: '我二十五岁。' },
              { id: 42, russian: 'Э́то зда́ние высо́кое.', chinese: '这座楼很高。' },
              { id: 43, russian: 'Краси́вая пло́щадь в це́нтре.', chinese: '市中心有个漂亮的广场。' },
              { id: 44, russian: 'У вас есть свобо́дное вре́мя?', chinese: '您有空吗？' },
              { id: 45, russian: 'Э́то моя́ су́мка.', chinese: '这是我的包。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Моя́ семья́ небольша́я.', chinese: '我的家庭不大。' },
              { id: 27, russian: 'У меня́ есть мать и отец.', chinese: '我有母亲和父亲。' },
              { id: 28, russian: 'Моя́ ма́ма до́брая.', chinese: '我妈妈很善良。' },
              { id: 29, russian: 'Мой па́па стро́гий.', chinese: '我爸爸很严格。' },
              { id: 30, russian: 'Мои́ роди́тели рабо́тают.', chinese: '我的父母在工作。' },
              { id: 31, russian: 'У меня́ нет сестёр.', chinese: '我没有姐妹。' },
              { id: 32, russian: 'Мой брат ста́рше меня́.', chinese: '我哥哥比我大。' },
              { id: 33, russian: 'Моя́ сестра́ мла́дше.', chinese: '我妹妹比我小。' },
              { id: 34, russian: 'На́ши де́душка и ба́бушка живу́т в дере́вне.', chinese: '我们的爷爷奶奶住在农村。' },
              { id: 35, russian: 'Я ча́сто навеща́ю ба́бушку.', chinese: '我经常看望奶奶。' },
              { id: 36, russian: 'Мой дя́дя — води́тель.', chinese: '我叔叔是司机。' },
              { id: 37, russian: 'Моя́ тётя рабо́тает в больни́це.', chinese: '我姑姑在医院工作。' },
              { id: 38, russian: 'У меня́ есть двою́родный брат.', chinese: '我有一个堂兄。' },
              { id: 39, russian: 'На́ша семья́ дру́жная.', chinese: '我们家庭和睦。' },
              { id: 40, russian: 'Мы обе́даем вме́сте.', chinese: '我们一起吃午饭。' },
              { id: 41, russian: 'По вы́ходным мы е́здим к ба́бушке.', chinese: '周末我们去奶奶家。' },
              { id: 42, russian: 'Мои́ роди́тели лю́бят меня́.', chinese: '我的父母爱我。' },
              { id: 43, russian: 'Я помога́ю ма́ме до́ма.', chinese: '我在家帮妈妈。' },
              { id: 44, russian: 'Мой сын у́чится в шко́ле.', chinese: '我儿子在学校上学。' },
              { id: 45, russian: 'Моя́ дочь ма́ленькая.', chinese: '我女儿还小。' },
              { id: 46, russian: 'Мы отме́чаем день рожде́ния вме́сте.', chinese: '我们一起庆祝生日。' },
              { id: 47, russian: 'В на́шей семье́ четве́ро.', chinese: '我们家四口人。' },
              { id: 48, russian: 'Я люблю́ госте́й.', chinese: '我喜欢客人。' },
              { id: 49, russian: 'Моя́ ба́бушка печёт пироги́.', chinese: '我奶奶烤馅饼。' },
              { id: 50, russian: 'Семья́ — э́то мой дом.', chinese: '家人就是我的家。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Мой день начина́ется ра́но.', chinese: '我的一天开始得很早。' },
              { id: 27, russian: 'Я просыпа́юсь в шесть.', chinese: '我六点醒来。' },
              { id: 28, russian: 'Я не встаю́ ра́но в выходны́е.', chinese: '周末我不早起。' },
              { id: 29, russian: 'У́тром я принима́ю душ.', chinese: '早上我洗澡。' },
              { id: 30, russian: 'Я чи́щу зу́бы ка́ждое у́тро.', chinese: '我每天早上刷牙。' },
              { id: 31, russian: 'По́сле за́втрака я иду́ на рабо́ту.', chinese: '早饭后我去上班。' },
              { id: 32, russian: 'Я е́ду на авто́бусе.', chinese: '我坐公交车。' },
              { id: 33, russian: 'Доро́га до рабо́ты два́дцать мину́т.', chinese: '上班路程二十分钟。' },
              { id: 34, russian: 'В о́фисе я рабо́таю за компью́тером.', chinese: '在办公室我用电脑工作。' },
              { id: 35, russian: 'Я пью ко́фе днём.', chinese: '我白天喝咖啡。' },
              { id: 36, russian: 'В оди́ннадцать у меня́ переры́в.', chinese: '十一点我休息。' },
              { id: 37, russian: 'Я переку́сываю в кафе́.', chinese: '我在咖啡馆吃点东西。' },
              { id: 38, russian: 'По́сле обе́да я рабо́таю ещё.', chinese: '午饭后我继续工作。' },
              { id: 39, russian: 'В шесть часо́в я свобо́ден.', chinese: '六点我就有空了。' },
              { id: 40, russian: 'До́ма я гото́влю у́жин.', chinese: '在家我做晚饭。' },
              { id: 41, russian: 'Я люблю́ гото́вить суп.', chinese: '我喜欢做汤。' },
              { id: 42, russian: 'Ве́чером я смотрю́ фильм.', chinese: '晚上我看电影。' },
              { id: 43, russian: 'Ино́гда я встреча́юсь с друзья́ми.', chinese: '有时我和朋友见面。' },
              { id: 44, russian: 'Мы гуля́ем в па́рке.', chinese: '我们在公园散步。' },
              { id: 45, russian: 'В де́сять я чита́ю кни́гу.', chinese: '十点我读书。' },
              { id: 46, russian: 'Я слу́шаю му́зыку пе́ред сном.', chinese: '睡前我听音乐。' },
              { id: 47, russian: 'Я ложу́сь спать в оди́ннадцать.', chinese: '我十一点上床睡觉。' },
              { id: 48, russian: 'Ка́ждый день похо́ж на друго́й.', chinese: '每天都很相似。' },
              { id: 49, russian: 'Но выходны́е — друго́е де́ло.', chinese: '但周末是另一回事。' },
              { id: 50, russian: 'Я отдыха́ю от рабо́ты в выходны́е.', chinese: '周末我从工作中休息。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Я хочу́ пить.', chinese: '我想喝水。' },
              { id: 27, russian: 'Дава́й зака́жем пи́ццу.', chinese: '我们点披萨吧。' },
              { id: 28, russian: 'В меню́ есть суп и сала́т.', chinese: '菜单上有汤和沙拉。' },
              { id: 29, russian: 'Я хочу́ кусо́к то́рта.', chinese: '我想要一块蛋糕。' },
              { id: 30, russian: 'Моро́женое о́чень вку́сное.', chinese: '冰淇淋很好吃。' },
              { id: 31, russian: 'Я люблю́ сок из апельси́нов.', chinese: '我喜欢橙汁。' },
              { id: 32, russian: 'Хлеб и ма́сло на столе́.', chinese: '面包和黄油在桌上。' },
              { id: 33, russian: 'Я ем суп с хле́бом.', chinese: '我吃汤配面包。' },
              { id: 34, russian: 'Мне нра́вится горя́чий чай.', chinese: '我喜欢热茶。' },
              { id: 35, russian: 'Э́тот суп сли́шком горя́чий.', chinese: '这汤太烫了。' },
              { id: 36, russian: 'Я не люблю́ о́струю еду́.', chinese: '我不喜欢辣的食物。' },
              { id: 37, russian: 'В рестора́не мно́го люде́й.', chinese: '餐厅里有很多人。' },
              { id: 38, russian: 'Мы за́втракаем до́ма.', chinese: '我们在家吃早饭。' },
              { id: 39, russian: 'Я пью во́ду по́сле еды́.', chinese: '饭后我喝水。' },
              { id: 40, russian: 'Ско́лько сто́ит ча́шка ко́фе?', chinese: '一杯咖啡多少钱？' },
              { id: 41, russian: 'Мне, пожа́луйста, ещё чай.', chinese: '请再给我一杯茶。' },
              { id: 42, russian: 'Э́тот рестора́н хоро́ший.', chinese: '这家餐厅不错。' },
              { id: 43, russian: 'Я хочу́ стол у окна́.', chinese: '我想要靠窗的桌子。' },
              { id: 44, russian: 'Приходи́те ещё!', chinese: '欢迎再来！' },
              { id: 45, russian: 'Сего́дня я гото́влю сам.', chinese: '今天我亲自做饭。' },
              { id: 46, russian: 'У меня́ есть реце́пт.', chinese: '我有食谱。' },
              { id: 47, russian: 'Мы покупа́ем проду́кты в магази́не.', chinese: '我们在商店买食品。' },
              { id: 48, russian: 'На у́жин у нас ры́ба.', chinese: '我们晚饭吃鱼。' },
              { id: 49, russian: 'Я не ем свини́ну.', chinese: '我不吃猪肉。' },
              { id: 50, russian: 'Спаси́бо, вку́сно!', chinese: '谢谢，真好吃！' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Магази́н откры́т.', chinese: '商店开门了。' },
              { id: 27, russian: 'Магази́н закры́т сего́дня.', chinese: '今天商店关门。' },
              { id: 28, russian: 'Во ско́лько открыва́ется магази́н?', chinese: '商店几点开门？' },
              { id: 29, russian: 'Я иду́ за проду́ктами.', chinese: '我去买食品。' },
              { id: 30, russian: 'Ну́жен ли вам паке́т?', chinese: '您需要袋子吗？' },
              { id: 31, russian: 'Э́ти я́блоки све́жие.', chinese: '这些苹果很新鲜。' },
              { id: 32, russian: 'Мо́жно попро́бовать сыр?', chinese: '可以尝尝奶酪吗？' },
              { id: 33, russian: 'Я возьму́ два бато́на.', chinese: '我要两条面包。' },
              { id: 34, russian: 'Ско́лько сто́ит килогра́мм карто́шки?', chinese: '一公斤土豆多少钱？' },
              { id: 35, russian: 'У вас есть ски́дка для студе́нтов?', chinese: '你们有学生折扣吗？' },
              { id: 36, russian: 'Я оплачу́ ка́ртой.', chinese: '我刷卡支付。' },
              { id: 37, russian: 'Где бли́же всего́ суперма́ркет?', chinese: '最近的超市在哪里？' },
              { id: 38, russian: 'Мне ну́жен спи́сок поку́пок.', chinese: '我需要购物清单。' },
              { id: 39, russian: 'Мы купи́ли мно́го проду́ктов.', chinese: '我们买了很多食品。' },
              { id: 40, russian: 'Э́ти боти́нки краси́вые.', chinese: '这双靴子很漂亮。' },
              { id: 41, russian: 'Како́й цвет вам нра́вится?', chinese: '您喜欢什么颜色？' },
              { id: 42, russian: 'Чёрный или кори́чневый?', chinese: '黑色还是棕色？' },
              { id: 43, russian: 'Э́та ко́фта тёплая.', chinese: '这件毛衣很暖和。' },
              { id: 44, russian: 'Мне ну́жно купи́ть пода́рок.', chinese: '我需要买礼物。' },
              { id: 45, russian: 'Пода́рок для дру́га.', chinese: '给朋友的礼物。' },
              { id: 46, russian: 'Э́та игру́шка для ребёнка.', chinese: '这个玩具是给孩子的。' },
              { id: 47, russian: 'Где отде́л игру́шек?', chinese: '玩具部在哪里？' },
              { id: 48, russian: 'Я верну́сь по́зже.', chinese: '我晚点再来。' },
              { id: 49, russian: 'Хоро́ших поку́пок!', chinese: '祝您购物愉快！' },
              { id: 50, russian: 'Э́то после́дняя вещь?', chinese: '这是最后一件吗？' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Где ближа́йшая ста́нция метро́?', chinese: '最近的地铁站在哪里？' },
              { id: 27, russian: 'Ста́нция там, за угло́м.', chinese: '车站在那边拐角处。' },
              { id: 28, russian: 'Я жду авто́бус.', chinese: '我在等公交车。' },
              { id: 29, russian: 'Авто́бус опа́здывает.', chinese: '公交车晚点了。' },
              { id: 30, russian: 'Во ско́лько отправле́ние?', chinese: '几点发车？' },
              { id: 31, russian: 'Пое́зд отправля́ется в де́вять.', chinese: '火车九点发车。' },
              { id: 32, russian: 'Я е́ду на трамва́е.', chinese: '我坐有轨电车。' },
              { id: 33, russian: 'Где остано́вка трамва́я?', chinese: '有轨电车站在哪里？' },
              { id: 34, russian: 'Биле́т в оди́н коне́ц, пожа́луйста.', chinese: '请给我一张单程票。' },
              { id: 35, russian: 'И обра́тный биле́т то́же.', chinese: '也要返程票。' },
              { id: 36, russian: 'Ско́лько остано́вок до це́нтра?', chinese: '到市中心有几站？' },
              { id: 37, russian: 'Три остано́вки, пожа́луйста.', chinese: '三站。' },
              { id: 38, russian: 'Здесь выходи́ть?', chinese: '在这里下车吗？' },
              { id: 39, russian: 'Нет, сле́дующая остано́вка.', chinese: '不，下一站。' },
              { id: 40, russian: 'Я потеря́л доро́гу.', chinese: '我迷路了。' },
              { id: 41, russian: 'Где я нахожу́сь?', chinese: '我在哪里？' },
              { id: 42, russian: 'Покажи́те на ка́рте, пожа́луйста.', chinese: '请在地图上指给我看。' },
              { id: 43, russian: 'Э́то далеко́?', chinese: '远吗？' },
              { id: 44, russian: 'Нет, бли́зко.', chinese: '不远，很近。' },
              { id: 45, russian: 'Я пойду́ пешко́м.', chinese: '我走路去。' },
              { id: 46, russian: 'Пешко́м о́коло десяти́ мину́т.', chinese: '步行大约十分钟。' },
              { id: 47, russian: 'Где остано́вка такси́?', chinese: '出租车停靠站在哪里？' },
              { id: 48, russian: 'Останови́те здесь, пожа́луйста.', chinese: '请在这里停车。' },
              { id: 49, russian: 'Ско́лько я до́лжен?', chinese: '我该付多少钱？' },
              { id: 50, russian: 'Вот ва́ша сда́ча.', chinese: '这是找您的零钱。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Кото́рый час сейча́с?', chinese: '现在几点了？' },
              { id: 27, russian: 'Сейча́с оди́ннадцать часо́в.', chinese: '现在十一点。' },
              { id: 28, russian: 'Уже́ два часа́ дня.', chinese: '已经下午两点了。' },
              { id: 29, russian: 'Через час бу́дет пять.', chinese: '一小时后是五点。' },
              { id: 30, russian: 'Я встаю́ в шесть утра́.', chinese: '我早上六点起床。' },
              { id: 31, russian: 'Ве́чером я свобо́ден.', chinese: '晚上我有空。' },
              { id: 32, russian: 'Како́й сего́дня день неде́ли?', chinese: '今天星期几？' },
              { id: 33, russian: 'Сегодня́ среда́.', chinese: '今天是星期三。' },
              { id: 34, russian: 'Послеза́втра бу́дет четве́рг.', chinese: '后天是星期四。' },
              { id: 35, russian: 'Вчера́ была́ пя́тница?', chinese: '昨天是星期五吗？' },
              { id: 36, russian: 'Како́е число́ бу́дет за́втра?', chinese: '明天是几号？' },
              { id: 37, russian: 'Сегодня́ тре́тье октября́.', chinese: '今天是十月三日。' },
              { id: 38, russian: 'Мой день рожде́ния в ию́ле.', chinese: '我的生日在七月。' },
              { id: 39, russian: 'Но́вый год в январе́.', chinese: '新年在一月。' },
              { id: 40, russian: 'Весна́ — в ма́рте, апре́ле, ма́е.', chinese: '春天在三月、四月、五月。' },
              { id: 41, russian: 'Ле́то — в ию́не, ию́ле, а́вгусте.', chinese: '夏天在六月、七月、八月。' },
              { id: 42, russian: 'О́сень — в сентябре́, октябре́, ноябре́.', chinese: '秋天在九月、十月、十一月。' },
              { id: 43, russian: 'Зима́ — в декабре́, январе́, феврале́.', chinese: '冬天在十二月、一月、二月。' },
              { id: 44, russian: 'Я рабо́таю в суббо́ту.', chinese: '我周六工作。' },
              { id: 45, russian: 'В воскресе́нье я отдыха́ю.', chinese: '周日我休息。' },
              { id: 46, russian: 'Уро́к начина́ется в де́сять.', chinese: '课十点开始。' },
              { id: 47, russian: 'Уро́к зака́нчивается в оди́ннадцать.', chinese: '课十一点结束。' },
              { id: 48, russian: 'Мы встреча́емся за́втра.', chinese: '我们明天见面。' },
              { id: 49, russian: 'Не опа́здывай, пожа́луйста.', chinese: '请不要迟到。' },
              { id: 50, russian: 'У меня́ мно́го вре́мени.', chinese: '我有很多时间。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'Сего́дня тепло́.', chinese: '今天暖和。' },
              { id: 27, russian: 'На у́лице плюс де́сять.', chinese: '外面零上十度。' },
              { id: 28, russian: 'Со́лнце све́тит я́рко.', chinese: '阳光灿烂。' },
              { id: 29, russian: 'Не́бо голубо́е.', chinese: '天空很蓝。' },
              { id: 30, russian: 'Идёт дождь.', chinese: '在下雨。' },
              { id: 31, russian: 'Дождь идёт це́лый день.', chinese: '雨下了一整天。' },
              { id: 32, russian: 'Лу́жи на доро́ге.', chinese: '路上有水洼。' },
              { id: 33, russian: 'Ве́трено сего́дня.', chinese: '今天有风。' },
              { id: 34, russian: 'Дере́вья кача́ются.', chinese: '树在摇晃。' },
              { id: 35, russian: 'Зимо́й быва́ет о́чень хо́лодно.', chinese: '冬天有时很冷。' },
              { id: 36, russian: 'Снег па́дает на зе́млю.', chinese: '雪落在地上。' },
              { id: 37, russian: 'Де́ти ле́пят снеговика́.', chinese: '孩子们在堆雪人。' },
              { id: 38, russian: 'Весно́й та́ет снег.', chinese: '春天雪融化。' },
              { id: 39, russian: 'Пти́цы пою́т весно́й.', chinese: '春天鸟儿歌唱。' },
              { id: 40, russian: 'Ле́том тепло́ и со́лнечно.', chinese: '夏天温暖晴朗。' },
              { id: 41, russian: 'Я купа́юсь в мо́ре ле́том.', chinese: '夏天我在海里游泳。' },
              { id: 42, russian: 'О́сенью ли́стья жёлтые.', chinese: '秋天叶子是黄色的。' },
              { id: 43, russian: 'Ли́стья па́дают на зе́млю.', chinese: '树叶落在地上。' },
              { id: 44, russian: 'Я наде́л ку́ртку.', chinese: '我穿上了外套。' },
              { id: 45, russian: 'Мне ну́жен зонт.', chinese: '我需要伞。' },
              { id: 46, russian: 'Како́й прогно́з на за́втра?', chinese: '明天天气预报怎么样？' },
              { id: 47, russian: 'Бу́дет дождли́во.', chinese: '会下雨。' },
              { id: 48, russian: 'Я наде́юсь, бу́дет со́лнечно.', chinese: '我希望会是晴天。' },
              { id: 49, russian: 'Мне нра́вится така́я пого́да.', chinese: '我喜欢这样的天气。' },
              { id: 50, russian: 'Пого́да хоро́шая для прогу́лки.', chinese: '天气适合散步。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 26, russian: 'У меня́ боли́т зу́б.', chinese: '我牙疼。' },
              { id: 27, russian: 'У меня́ боли́т живо́т.', chinese: '我肚子疼。' },
              { id: 28, russian: 'У меня́ боли́т спина́.', chinese: '我背疼。' },
              { id: 29, russian: 'Я уста́л.', chinese: '我累了。' },
              { id: 30, russian: 'Я пло́хо сплю.', chinese: '我睡得不好。' },
              { id: 31, russian: 'У меня́ боли́т у́хо.', chinese: '我耳朵疼。' },
              { id: 32, russian: 'Я простуди́лся.', chinese: '我感冒了。' },
              { id: 33, russian: 'Я чиха́ю.', chinese: '我打喷嚏。' },
              { id: 34, russian: 'У меня́ сла́бость.', chinese: '我浑身无力。' },
              { id: 35, russian: 'Мне жа́рко.', chinese: '我觉得热。' },
              { id: 36, russian: 'Я принима́ю лека́рства.', chinese: '我在吃药。' },
              { id: 37, russian: 'Табле́тки от головно́й бо́ли.', chinese: '治头疼的药片。' },
              { id: 38, russian: 'Я пью горя́чий чай с лимо́ном.', chinese: '我喝加柠檬的热茶。' },
              { id: 39, russian: 'Врач сказа́л отдыха́ть.', chinese: '医生说要休息。' },
              { id: 40, russian: 'Я иду́ в поликли́нику.', chinese: '我去诊所。' },
              { id: 41, russian: 'Запиши́те меня́ к врачу́.', chinese: '请帮我约医生。' },
              { id: 42, russian: 'У меня́ назна́чено к десяти́.', chinese: '我约了十点。' },
              { id: 43, russian: 'Как ва́ше здоро́вье?', chinese: '您身体怎么样？' },
              { id: 44, russian: 'Здоро́вье хоро́шее.', chinese: '身体很好。' },
              { id: 45, russian: 'Я де́лаю заря́дку у́тром.', chinese: '我早上做操。' },
              { id: 46, russian: 'Я гуля́ю ка́ждый день.', chinese: '我每天散步。' },
              { id: 47, russian: 'Све́жий во́здух поле́зен.', chinese: '新鲜空气有益健康。' },
              { id: 48, russian: 'Я сплю во́семь часо́в.', chinese: '我睡八个小时。' },
              { id: 49, russian: 'Не боле́йте!', chinese: '别生病！' },
              { id: 50, russian: 'Береги́те себя́!', chinese: '保重身体！' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 21, russian: 'Э́тот цвет краси́вый.', chinese: '这个颜色很漂亮。' },
              { id: 22, russian: 'Како́й цвет у твое́й маши́ны?', chinese: '你的车是什么颜色？' },
              { id: 23, russian: 'Моя́ маши́на бе́лая.', chinese: '我的车是白色的。' },
              { id: 24, russian: 'У неё ры́жие во́лосы.', chinese: '她有棕红色的头发。' },
              { id: 25, russian: 'Э́то си́нее не́бо.', chinese: '这是蓝色的天空。' },
              { id: 26, russian: 'Зелёные глаза́ краси́вые.', chinese: '绿色的眼睛很漂亮。' },
              { id: 27, russian: 'Жёлтое со́лнце на не́бе.', chinese: '天空中的黄色太阳。' },
              { id: 28, russian: 'Чёрная ко́шка в до́ме.', chinese: '家里有只黑猫。' },
              { id: 29, russian: 'Бе́лый хлеб на столе́.', chinese: '桌上放着白面包。' },
              { id: 30, russian: 'Кра́сные ро́зы для тебя́.', chinese: '红玫瑰送给你。' },
              { id: 31, russian: 'Ро́зовые цветы́ в саду́.', chinese: '花园里有粉色的花。' },
              { id: 32, russian: 'Голубо́й цвет — э́то све́тло-си́ний.', chinese: '天蓝色就是浅蓝色。' },
              { id: 33, russian: 'Ора́нжевый — э́то жёлтый и кра́сный.', chinese: '橙色就是黄色加红色。' },
              { id: 34, russian: 'Како́й цвет тебе́ бо́льше нра́вится?', chinese: '你更喜欢什么颜色？' },
              { id: 35, russian: 'Мне нра́вится се́рый цвет.', chinese: '我喜欢灰色。' },
              { id: 36, russian: 'Э́тот костю́м кори́чневый.', chinese: '这套西装是棕色的。' },
              { id: 37, russian: 'Фиоле́товая ю́бка краси́вая.', chinese: '紫色裙子很漂亮。' },
              { id: 38, russian: 'Золото́е кольцо́ дорого́е.', chinese: '金戒指很贵。' },
              { id: 39, russian: 'Сере́бряные часы́ на руке́.', chinese: '手腕上戴着银表。' },
              { id: 40, russian: 'Кру́глый стол в ку́хне.', chinese: '厨房里有圆桌。' },
              { id: 41, russian: 'Квадра́тное окно́ необы́чное.', chinese: '方形的窗户不寻常。' },
              { id: 42, russian: 'Треуго́льный знак на доро́ге.', chinese: '路上的三角形标志。' },
              { id: 43, russian: 'Дли́нная ли́ния на бу́маге.', chinese: '纸上的长线。' },
              { id: 44, russian: 'То́чка ма́ленькая.', chinese: '点很小。' },
              { id: 45, russian: 'Цвета́ вокру́г нас краси́вые.', chinese: '我们周围的颜色很美。' }
            ]
          }
        ]
      },
        ...
        videos: [
          {
            ...
            sentences: [
              ...
              { id: 21, russian: 'В до́ме пять ко́мнат.', chinese: '房子里有五个房间。' },
              { id: 22, russian: 'Гости́ная больша́я и све́тлая.', chinese: '客厅又大又亮。' },
              { id: 23, russian: 'Ку́хня ря́дом со сто́ловой.', chinese: '厨房在餐厅旁边。' },
              { id: 24, russian: 'В спа́льне ти́хо.', chinese: '卧室里很安静。' },
              { id: 25, russian: 'Де́тская ко́мната у́тром со́лнечная.', chinese: '儿童房早上充满阳光。' },
              { id: 26, russian: 'На полу́ деревя́нный пол.', chinese: '地板是木制的。' },
              { id: 27, russian: 'Потоло́к бе́лый.', chinese: '天花板是白色的。' },
              { id: 28, russian: 'Стена́ голуба́я.', chinese: '墙是蓝色的。' },
              { id: 29, russian: 'В ко́мнате тепло́.', chinese: '房间里暖和。' },
              { id: 30, russian: 'Окно́ откры́то.', chinese: '窗户开着。' },
              { id: 31, russian: 'Што́ры кра́сные.', chinese: '窗帘是红色的。' },
              { id: 32, russian: 'Сто́лик у крова́ти.', chinese: '床头柜在床边。' },
              { id: 33, russian: 'В шкафу́ мно́го оде́жды.', chinese: '衣柜里有很多衣服。' },
              { id: 34, russian: 'Ковёр на полу́ мя́гкий.', chinese: '地上的地毯很软。' },
              { id: 35, russian: 'Ла́мпа све́тит хорошо́.', chinese: '台灯照得很亮。' },
              { id: 36, russian: 'В ва́нной ко́мнате есть ва́нна.', chinese: '浴室里有浴缸。' },
              { id: 37, russian: 'Зу́бная щётка в стака́не.', chinese: '牙刷在杯子里。' },
              { id: 38, russian: 'Полоте́нце виси́т на крючке́.', chinese: '毛巾挂在钩子上。' },
              { id: 39, russian: 'Мы́ло на по́лке.', chinese: '肥皂在架子上。' },
              { id: 40, russian: 'Прихо́жая ма́ленькая.', chinese: '门厅很小。' },
              { id: 41, russian: 'Зе́ркало в прихо́жей.', chinese: '门厅里有镜子。' },
              { id: 42, russian: 'Балко́н выхо́дит в сад.', chinese: '阳台朝向花园。' },
              { id: 43, russian: 'На балко́не стои́т стул.', chinese: '阳台上放着一把椅子。' },
              { id: 44, russian: 'Я убира́ю в ко́мнате ка́ждую неде́лю.', chinese: '我每周打扫房间。' },
              { id: 45, russian: 'Мой дом — моя́ кре́пость.', chinese: '我的家就是我的城堡。' }
            ]
          }
        ]
      }
