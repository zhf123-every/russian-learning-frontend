  ...
  return (
    <header className="app-topbar">
      ...
      <div className="ml-auto flex items-center gap-3">
        ...
        <button className="inline-flex text-sm text-gray-600 opacity-60 cursor-not-allowed" title="即将上线">推广赚佣金</button>
        <button className="inline-flex text-sm text-gray-600 opacity-60 cursor-not-allowed" title="即将上线">帮助与反馈</button>
        <span className="block text-gray-300">|</span>
