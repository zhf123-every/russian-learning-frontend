...
const MAIN_CATS = ['教材同步', '考试备考', '少儿俄语', '基础俄语', '语法专项', '场景俄语', '阅读听力', '影视俄语', '音乐俄语']
const SUBCATS = {
  '推荐': ['全部'],
  ...
  '语法专项': ['全部', '主格·起源之力', '属格·剥夺之网', '与格·赋权之赐', '宾格·直击之矛', '工具格·创造之锤', '前置格·空间之钥'],
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        views: 0,
        createdAt: Date.now(),
        isGrammar: form.cat === '语法专项', // 语法专项分类 = 语法课程（点亮变格天赋树）
