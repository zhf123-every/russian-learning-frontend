  ...
  return (
    <div style={{
      ...
      <style>{`
        ...
        .cg-cell:hover{ transform: scale(1.25); outline: 2px solid ${theme === 'dark' ? '#818CF8' : 'oklch(23.27% 0.0249 284.3)'}; outline-offset: 1px; }
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, flexWrap: 'wrap', gap: 8 }}>
        ...
        <div style={{ display: 'flex', gap: 16, fontSize: 12, color: T.sub }}>
          ...
          <span>连续 <b style={{ color: 'oklch(23.27% 0.0249 284.3)' }}>{currentStreak}</b> 天</span>
          <span>最长 <b style={{ color: 'oklch(23.27% 0.0249 284.3)' }}>{longestStreak}</b> 天</span>
        </div>
      </div>
