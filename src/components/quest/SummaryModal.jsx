...
function useConfetti(canvasRef, active) {
  ...
  const spawn = useCallback((count = 120) => {
    ...
    const colors = ['#FFD75E', '#FF8A5C', 'oklch(23.27% 0.0249 284.3)', '#7ED6A5', '#6FB7FF', '#FF6B9D', 'oklch(23.27% 0.0249 284.3)']
    const ps = []
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, justifyContent: 'center' }}>
            <button className="sum-btn" onClick={() => { onShare && onShare() }} style={{
              ...
              background: 'linear-gradient(135deg,oklch(23.27% 0.0249 284.3),oklch(23.27% 0.0249 284.3))', color: '#fff',
