...
const styles = {
  ...
  mallScroll: { margin: '0 auto', padding: '0 16px', maxHeight: '79vh', overflowY: 'auto', overflowX: 'hidden' },
  ...
  mallBody: { margin: '0 auto', padding: '26px 30px' },
  ...
  mallContent: { margin: '0 auto', padding: '40px 40px 80px' },
  ...
  detailContent: { margin: '0 auto', padding: '28px 40px 60px' },
